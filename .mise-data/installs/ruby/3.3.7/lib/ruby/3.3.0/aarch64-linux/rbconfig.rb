...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.3.0/aarch64-linux")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/linuxbrew/.linuxbrew/Cellar/jdx-ruby@3.3.7/3.3.7")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/linuxbrew/.linuxbrew/Cellar/jdx-ruby@3.3.7/3.3.7' '--enable-load-relative' '--without-ext=win32,win32ole' '--without-gmp' '--disable-install-doc' '--disable-install-rdoc' '--disable-dependency-tracking' '--enable-yjit' '--with-libyaml-dir=/home/linuxbrew/.linuxbrew/opt/portable-libyaml@0.2.5' '--with-libffi-dir=/home/linuxbrew/.linuxbrew/opt/portable-libffi@3.5.1' '--with-zlib-dir=/home/linuxbrew/.linuxbrew/opt/portable-zlib@1.3.1' 'MKDIR_P=/bin/mkdir -p' 'ac_cv_lib_z_uncompress=no' 'cflags=-fPIC' 'cxxflags=-fPIC' 'CC=cc' 'CXX=c++'"
  ...
  CONFIG["COMMON_LIBS"] = ""
  CONFIG["MAINLIBS"] = "-lrt -lrt -ldl -lcrypt -lm -lpthread "
  ...
  CONFIG["ARFLAGS"] = "rcD "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "cc (Ubuntu 12.3.0-1ubuntu1~22.04.2) 12.3.0\nCopyright (C) 2022 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  ...
  CONFIG["HAVE_GIT"] = "yes"
  CONFIG["GIT"] = "git"
  CONFIG["cxxflags"] = "-fPIC"
  CONFIG["cppflags"] = ""
  CONFIG["cflags"] = "-fPIC $(optflags) $(debugflags) $(warnflags)"
