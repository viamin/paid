...
#define CONFIGURE_ARGS " '--prefix=/workspace/.pg-install' '--without-readline' '--without-icu' '--without-zlib'"
...
#define PG_VERSION_STR "PostgreSQL 16.13 on aarch64-unknown-linux-gnu, compiled by gcc (Ubuntu 13.3.0-6ubuntu2~24.04.1) 13.3.0, 64-bit"
