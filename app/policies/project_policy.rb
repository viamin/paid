...
class ProjectPolicy < ApplicationPolicy
  ...
  # - create?, new?: owner/admin/member (overridden below)
  # - update?, edit?: owner/admin
  # - destroy?: owner only
  #
  # Project-specific permissions:
  # - create?: restricted to owner/admin (not members)
  ...
  def has_project_role?
    ...
    user.has_any_role?({ name: :admin, resource: record }, { name: :member, resource: record })
  end
end
