  ...
  module Profiles
    ...
    module Settings
      ...
      EXCLUDED_ATTRIBUTE_COLUMNS = {
        ...
        "pr_aggregation_enabled" => "feature removed, column retained for one compatibility release; see db/migrate/20260903034209_remove_pr_aggregation_enabled_from_projects"
      }.freeze
