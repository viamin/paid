  ...
  module Strategies
    class AutoContinue
      ...
      class Signals < ::Data.define(
        ...
        :pr_auto_continue_token_limit_reached,
        :pr_auto_continue_tokens_used,
        ...
        class << self
          def from_metadata(metadata)
            ...
            new(
              ...
              pr_auto_continue_token_limit_reached: value_for(lifecycle, :pr_auto_continue_token_limit_reached) == true,
              pr_auto_continue_tokens_used: value_for(lifecycle, :pr_auto_continue_tokens_used).to_i,
              pr_auto_continue_token_limit: value_for(lifecycle, :pr_auto_continue_token_limit).to_i,
