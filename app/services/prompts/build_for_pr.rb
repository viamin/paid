...
module Prompts
  ...
  class BuildForPr
    ...
    def prompt_settings
      @prompt_settings ||= AgentRuns::UserSettingsResolver.call(project: project, strict: false)
    end

    def max_prompt_comments
      prompt_settings&.max_prompt_comments || BuildForIssue::DEFAULT_MAX_COMMENTS
    end

    def max_comment_length
      prompt_settings&.max_comment_length || BuildForIssue::DEFAULT_MAX_COMMENT_LENGTH
    end
