...
module Knowledge
  class Search
    class Hybrid
      attr_reader :project, :query, :artifact_type, :version, :limit, :api_key, :api_base_url

      def initialize(project:, query:, artifact_type: nil, version: nil, limit: 20, api_key: nil, api_base_url: nil)
        @project = project
        @query = query
