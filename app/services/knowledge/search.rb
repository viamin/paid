...
module Knowledge
  class Search
    ...
    attr_reader :project, :query, :mode, :artifact_type, :version, :limit, :agent_run_id

    def initialize(project:, query:, mode: DEFAULT_MODE, artifact_type: nil, version: nil, limit: DEFAULT_LIMIT, agent_run_id: nil)
      @project = project
      @query = query
