...
module Experiments
  # Pure math primitives shared by all experiment frameworks
  # (ab_tests, configuration_experiments, strategy_experiments,
  # style_guide_ab_tests). Welch's t-test, sample mean, and standard
  # deviation live here so the math is defined exactly once.
  module Statistics
    module_function
