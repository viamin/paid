...
module AgentRuns
  ...
  class DiagnoseError
    ...
    def diagnosis_prompt
      error_text = @agent_run.error_message.truncate(MAX_ERROR_INPUT, omission: "")
      logs_text = recent_logs.truncate(MAX_LOG_INPUT, omission: "")
    ...
    def issue_body(diagnosis)
      <<~BODY.strip
        ...
        **Goal:** #{@agent_run.goal}
        ...
        ### Error
        ```
        #{@agent_run.error_message.truncate(2000)}
        ```
