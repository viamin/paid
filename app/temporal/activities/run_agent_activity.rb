...
module Activities
  class RunAgentActivity < BaseActivity
    ...
    def selected_runner_runtime(runner_candidate, user, agent_run)
      ...
      configured_runtime = runner_entry&.agent_harness_runner_runtime(project: agent_run&.project)
      ...
      if runner_entry&.free_model_policy?
        if model_id.blank?
          raise RunnerExecutionError,
            "free-model runner #{runner_entry.id} has no resolvable free model for this run"
        end
