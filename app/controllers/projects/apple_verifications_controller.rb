...
module Projects
  ...
  class AppleVerificationsController < ApplicationController
    ...
    def show
      ...
      @attempts = @project.apple_verification_attempts.includes(
        { apple_verification_workflow_revision: :apple_worker_profile },
        :apple_verification_artifacts,
        :apple_verification_waivers,
        :execution_audit_events,
        :execution_resource_ledger_entries
