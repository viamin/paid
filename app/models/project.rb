...
class Project < ApplicationRecord
  ...
  AUTOMATION_SETTINGS = [
    { label: "Auto-Add Labels", attribute: :auto_add_labels_enabled,
     description: "Automatically add the generated label to PRs and issues created by Paid." },
    { label: "Automation on Label", attribute: :automation_on_label_enabled,
     description: "Automatically create agent runs when the automation label is detected on issues or PRs." },
    { label: "Auto-Pick Issues", attribute: :auto_pick_enabled,
     description: "Automatically start working on unblocked issues when no agent runs are active." },
    { label: "Auto-Merge", attribute: :auto_merge_enabled,
     description: "Automatically merge PRs generated by Paid that are in a paid-ready state, have no unresolved review comments, and pass all CI checks." },
    { label: "Auto-Fix Merge Conflicts", attribute: :auto_fix_merge_conflicts,
     description: "Automatically start a PR follow-up run when a paid-ready PR develops merge conflicts against the base branch." }
  ].freeze
