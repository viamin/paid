...
class Account < ApplicationRecord
  ...
  has_many :claude_login_sessions, class_name: "ClaudeLoginSession", dependent: :destroy
  has_many :codex_login_sessions, class_name: "CodexLoginSession", dependent: :destroy
  ...
  has_many :docker_hosts, dependent: :destroy
