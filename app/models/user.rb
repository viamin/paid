...
class User < ApplicationRecord
  ...
  has_many :approved_apple_verification_workflow_revisions, class_name: "AppleVerificationWorkflowRevision", foreign_key: :approved_by_id, dependent: :nullify, inverse_of: :approved_by
