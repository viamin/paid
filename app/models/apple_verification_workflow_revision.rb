...
class AppleVerificationWorkflowRevision < ApplicationRecord
  ...
  def approval_binding_is_immutable
    ...
    return unless will_save_change_to_content_digest? || will_save_change_to_verification_files? || will_save_change_to_apple_worker_profile_id? || will_save_change_to_lifecycle_gate? || will_save_change_to_required_checks? || will_save_change_to_advisory_checks?
