...
- Avoid O(n^2) -- use index lookups over nested loops. `STYLE_GUIDE:1325-1340`
- Batch database operations. Use `find_each` for large record sets. `STYLE_GUIDE:1342-1363`
- Stream large files. Cache expensive operations with invalidation strategy. `STYLE_GUIDE:1364-1395`
