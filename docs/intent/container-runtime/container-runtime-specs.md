...
- [x] **CONTAINER-RUNTIME-019** — The system SHALL persist an `AgentImage`
...
- [x] **CONTAINER-RUNTIME-020** — The `AgentImage` record SHALL support a
...
- [x] **CONTAINER-RUNTIME-021** — The `AgentImage` registry SHALL enforce
...
- [x] **CONTAINER-RUNTIME-022** — The `AgentImage` record SHALL expose
