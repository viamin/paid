...
- [x] **INTENT-AMENDMENT-001** — For approval-gated features, when a human records a one-PR implementation
...
- [x] **INTENT-AMENDMENT-002** — For approval-gated features, when a human records a resolution that changes
...
- [x] **INTENT-AMENDMENT-003** — For approval-gated features, when a design amendment opens, the system
...
- [x] **INTENT-AMENDMENT-004** — For approval-gated features, when an approved amendment records its merged
...
- [x] **INTENT-AMENDMENT-005** — For approval-gated features, when impact is evaluated, the semantic
...
- [x] **INTENT-AMENDMENT-006** — For approval-gated features, the applied pause set SHALL consist of exactly
...
- [x] **INTENT-AMENDMENT-007** — For approval-gated features, when a branch's impact is `uncertain`, the
...
- [x] **INTENT-AMENDMENT-008** — For approval-gated features, when a merged PR is affected by the revision
...
- [x] **INTENT-AMENDMENT-009** — For approval-gated features, while a design-amendment hold is active, the
