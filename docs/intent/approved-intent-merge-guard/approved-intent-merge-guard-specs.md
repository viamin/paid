...
- [x] **INTENT-MERGE-GUARD-001** — The final-merge guard SHALL apply only when
...
- [x] **INTENT-MERGE-GUARD-002** — When no `IntentConformanceVerdict` exists
...
- [x] **INTENT-MERGE-GUARD-003** — When the current PR head SHA differs from
...
- [x] **INTENT-MERGE-GUARD-004** — When the feature intent's approved design
...
- [x] **INTENT-MERGE-GUARD-005** — While the issue has an active (held)
...
- [x] **INTENT-MERGE-GUARD-006** — A current verdict (matching PR head and
...
- [x] **INTENT-MERGE-GUARD-007** — A current verdict with outcome
...
- [x] **INTENT-MERGE-GUARD-008** — The guard SHALL re-verify PR head,
