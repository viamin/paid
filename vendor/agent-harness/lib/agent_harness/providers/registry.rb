  ...
  module Providers
    ...
    class Registry
      ...
      def register_builtin_providers
        ...
        register_if_available(:openai, "agent_harness/providers/openai", :Openai)
        register_if_available(:openrouter, "agent_harness/providers/openrouter", :Openrouter)
        register_if_available(:azure_openai, "agent_harness/providers/azure_openai", :AzureOpenai)
