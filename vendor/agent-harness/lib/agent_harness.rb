...
module AgentHarness
  ...
  class << self
    ...
    # Generate embeddings using the orchestration layer.
    #
    # @param texts [Array<String>] input texts to embed
    # @param provider [Symbol, nil] optional provider override
    ...
    # @return [EmbeddingResponse] response with vectors and token usage
    def embed(texts:, provider: nil, model:, dimensions: nil, **options)
      conductor.embed(texts: texts, provider: provider, model: model, dimensions: dimensions, **options)
    end
...
require_relative "agent_harness/embedding_response"
...
require_relative "agent_harness/providers/openai_compatible"
require_relative "agent_harness/providers/openai"
require_relative "agent_harness/providers/openrouter"
require_relative "agent_harness/providers/azure_openai"
