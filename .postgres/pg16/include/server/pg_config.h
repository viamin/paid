...
#define CONFIGURE_ARGS " '--prefix=/workspace/.postgres/pg16' '--with-openssl' '--with-zlib' '--with-uuid=e2fs' '--without-icu' '--without-xml' '--without-readline' '--with-libraries=/workspace/.postgres/devlibs/usr/lib/aarch64-linux-gnu:/lib/aarch64-linux-gnu' '--with-includes=/workspace/.postgres/devlibs/usr/include:/workspace/.postgres/devlibs/usr/include/aarch64-linux-gnu' 'CFLAGS=-I/workspace/.postgres/devlibs/usr/include -I/workspace/.postgres/devlibs/usr/include/aarch64-linux-gnu' 'LDFLAGS=-L/workspace/.postgres/devlibs/usr/lib/aarch64-linux-gnu -L/lib/aarch64-linux-gnu' 'CPPFLAGS=-I/workspace/.postgres/devlibs/usr/include -I/workspace/.postgres/devlibs/usr/include/aarch64-linux-gnu'"
...
#define PG_VERSION_STR "PostgreSQL 16.8 on aarch64-unknown-linux-gnu, compiled by gcc (Ubuntu 13.3.0-6ubuntu2~24.04.1) 13.3.0, 64-bit"
