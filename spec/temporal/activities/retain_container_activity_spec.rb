...
RSpec.describe Activities::RetainContainerActivity do
  ...
  describe "#execute" do
    it "sets container_retained_until on the agent run" do
      ...
      agent_run.reload
      expect(agent_run.container_retained_until).to be_within(1.minute).of(4.hours.from_now)
    end
    ...
    it "shortens retention TTL under disk pressure" do
      ...
      agent_run.reload
      expect(agent_run.container_retained_until).to be_within(1.minute).of(1.hour.from_now)
    end
  end
end
