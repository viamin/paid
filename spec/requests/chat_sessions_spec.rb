  ...
  describe "POST /chat" do
    ...
    context "when authenticated" do
      ...
      it "creates a new chat session" do
        expect {
          post chat_sessions_path, params: { mode: "api", title: "Test Chat" }
  ...
  describe "GET /chat/:id" do
    ...
    context "when authenticated" do
      ...
      it "does not return another account's session" do
        ...
        get chat_session_path(other_session)
  ...
  describe "PATCH /chat/:id" do
    ...
    context "when authenticated" do
      ...
      it "updates the session title" do
        patch chat_session_path(chat_session), params: { title: "Updated Title" }
        expect(response).to have_http_status(:ok)
      ...
      it "updates the model" do
        patch chat_session_path(chat_session), params: { model: "gpt-4o" }
        expect(response).to have_http_status(:ok)
