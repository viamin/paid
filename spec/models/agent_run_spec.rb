...
RSpec.describe AgentRun do
  ...
  describe "validations" do
    ...
    describe "issue project validation" do
      ...
      it "allows lid_planning without plan_docs, issue, or custom_prompt (prompt is always derived)" do
  ...
  describe "instance methods" do
    ...
    describe "#complete!" do
      ...
      it "does not enable required verification completion gates while execution is unavailable" do
        ...
        expect(agent_run.external_metadata).not_to have_key(described_class::COMPLETION_VERIFICATION_WITHHELD_METADATA_KEY)
      end
  ...
  describe "constants" do
    ...
    it "defines valid AGENT_TYPES" do
      expect(described_class::AGENT_TYPES).to eq(%w[claude_code cursor codex copilot gemini opencode kilocode pi omp api devin factory internal_agent])
    end
