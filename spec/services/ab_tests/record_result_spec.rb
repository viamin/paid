...
RSpec.describe AbTests::RecordResult do
  ...
  describe ".call" do
    it "records quality score on the assignment" do
      ...
      described_class.call(agent_run: agent_run, quality_score: 0.85)
    ...
    it "updates variant aggregate scores" do
      ...
      described_class.call(agent_run: agent_run, quality_score: 0.8)
    ...
    it "does nothing when agent_run has no assignment" do
      agent_run = create(:agent_run)
      expect { described_class.call(agent_run: agent_run, quality_score: 0.5) }.not_to raise_error
    end
  end
end
