...
## [1.13.0](https://github.com/viamin/paid/compare/v1.12.0...v1.13.0) (2026-09-26)


### Features

* [Feature] Paid should be able to create new projects. When adding a project in the projects page, there should be an option to .. ([#3993](https://github.com/viamin/paid/issues/3993)) ([9289256](https://github.com/viamin/paid/commit/9289256b9db23ed9f0e151039c7ed7f9caf69e9c))
* Add a freeform final text area to clarifying-questions answer forms ([#3970](https://github.com/viamin/paid/issues/3970)) ([d84297d](https://github.com/viamin/paid/commit/d84297d4dfd73136c8f3224a7ca0fcf0e3ae4a35))
* Add interactive mode to clarifying questions inbox flow ([#4026](https://github.com/viamin/paid/issues/4026)) ([d73fa48](https://github.com/viamin/paid/commit/d73fa48fc01882e49887c2759c22f2c94d7a58b8))
* Add project-level review depth presets for Paid PR reviewer ([#3904](https://github.com/viamin/paid/issues/3904)) ([9821d9f](https://github.com/viamin/paid/commit/9821d9ffaf26f2a7ac3bd7ae39f20a242c8cfb11))
...
* Auto-restart paused chats when runner exits rate limit period ([#3962](https://github.com/viamin/paid/issues/3962)) ([9085437](https://github.com/viamin/paid/commit/90854377b68bd780aabcbc91a8a347ffda35640e))
* Chat feature should prefer opening new issues rather than re-opening closed ones ([#4012](https://github.com/viamin/paid/issues/4012)) ([185aba1](https://github.com/viamin/paid/commit/185aba16b53031ee68649af9e92174c8725f10b0))
* **chat:** select eligible OpenRouter free models from the synced catalog ([#4023](https://github.com/viamin/paid/issues/4023)) ([4d7e874](https://github.com/viamin/paid/commit/4d7e8746faee20af48280626db116ff2f7c1aa52))
...
* Collapse chat session header by default so transcript + composer are the focus ([#3928](https://github.com/viamin/paid/issues/3928)) ([8991125](https://github.com/viamin/paid/commit/89911259cbf5eadead9db804e8cad23339b15bb8))
* Collapse chat session header by default so transcript + composer are the focus ([#4045](https://github.com/viamin/paid/issues/4045)) ([7cabdb7](https://github.com/viamin/paid/commit/7cabdb70d31b3056128f97f629213260dad4be49))
...
* Ensure open issues are never invisibly blocked by internal Paid state ([#4010](https://github.com/viamin/paid/issues/4010)) ([08c2045](https://github.com/viamin/paid/commit/08c20451f29349dc28cb3bad48a0c43198443225))
* Ensure re-opened issues are properly reviewed before being considered complete ([#4009](https://github.com/viamin/paid/issues/4009)) ([ac0d961](https://github.com/viamin/paid/commit/ac0d961974f222e4943a09c52ed974509ed0f24b))
* Evaluate specialist reviewer finders and optional second sweep ([#4028](https://github.com/viamin/paid/issues/4028)) ([aea91ed](https://github.com/viamin/paid/commit/aea91edf88af909eb226a0c0c1ff0cfb7170c1d4))
* **feature-design:** offer optional problem exploration in chat ([#4021](https://github.com/viamin/paid/issues/4021)) ([#4032](https://github.com/viamin/paid/issues/4032)) ([6674d45](https://github.com/viamin/paid/commit/6674d4585ad340c33b2e70a78ac06469c7cebc1f))
* **feature-design:** preserve problem framing in briefs and generated RDRs ([#4029](https://github.com/viamin/paid/issues/4029)) ([3b96eae](https://github.com/viamin/paid/commit/3b96eae6ec2b27adc0843d90a8e52e5700d22006))
...
* Interactive inbox chat: backend, session persistence, and context loading ([#4027](https://github.com/viamin/paid/issues/4027)) ([e074f1b](https://github.com/viamin/paid/commit/e074f1b563db57454f58e90478551042711fc15f))
...
* RDR-068: automate Apple worker setup and document operations ([#3985](https://github.com/viamin/paid/issues/3985)) ([dd1b1fb](https://github.com/viamin/paid/commit/dd1b1fb31b223048a03c8832c0508dea315225ac))
* RDR-068: define Apple verification intent and EARS contracts ([#3976](https://github.com/viamin/paid/issues/3976)) ([c6b3fe0](https://github.com/viamin/paid/commit/c6b3fe0f7c8cc6bc310fb9bd55b76d009b937aff))
* RDR-068: expose semantic Apple verification tools and lifecycle gates ([#3986](https://github.com/viamin/paid/issues/3986)) ([437fe13](https://github.com/viamin/paid/commit/437fe13bc7a0c98c0b79d5b9a81e8c2d5bf5463b))
* RDR-068: live-validate Apple platform verification workers on a macOS host ([#3979](https://github.com/viamin/paid/issues/3979)) ([12272f3](https://github.com/viamin/paid/commit/12272f30b427c04fc2deafe18f12144a3ac05abe))
* RDR-068: model Apple worker contracts, profiles, and verification state ([#3947](https://github.com/viamin/paid/issues/3947)) ([b233480](https://github.com/viamin/paid/commit/b233480b7b74ca3ac6ef2ed1b0d86960eee992d0))
* RDR-068: present Apple verification workflows, attempts, and artifacts ([#3949](https://github.com/viamin/paid/issues/3949)) ([75db31a](https://github.com/viamin/paid/commit/75db31a4c1420b241ee9ed0f3c5d2f858f1df2d1))
...
* CreateAgentRunActivity clobbers needs_input paid_state on unrelated run starts ([#3997](https://github.com/viamin/paid/issues/3997)) ([85c970a](https://github.com/viamin/paid/commit/85c970a60de053bb32d1dc3426466ace8bb46bcc))
...
* **db:** restore cable-only schema dump ([#3959](https://github.com/viamin/paid/issues/3959)) ([e20ffae](https://github.com/viamin/paid/commit/e20ffaebd4800b27fd6414c9a2ae099d9d58b938))
* **deps:** release agent-harness compatibility pin ([#4036](https://github.com/viamin/paid/issues/4036)) ([d266fe7](https://github.com/viamin/paid/commit/d266fe734a85ea9dfdc5eb26061b149f30bb5eaa))
...
* generate feature-specific clarification questions from the supplied description and repository ([#3960](https://github.com/viamin/paid/issues/3960)) ([5046e51](https://github.com/viamin/paid/commit/5046e51f6bcef8cb96ed5883919399282ab81798))
* **github-sync:** manually added `paid-needs-input` label is a silent no-op — no state change, no operator feedback, no cleanup ([#3999](https://github.com/viamin/paid/issues/3999)) ([3642cf8](https://github.com/viamin/paid/commit/3642cf8d8b22272920efc68a754ead8a170f86b2))
* **github-sync:** questionless needs_input repair skips PRs, so a parked PR can wedge outside the Inbox forever ([#4011](https://github.com/viamin/paid/issues/4011)) ([fdf5682](https://github.com/viamin/paid/commit/fdf5682f529d7a60819d6f9e0ce041125756723d))
...
* **inbox:** preserve full-page navigation from embedded chat controls ([#4040](https://github.com/viamin/paid/issues/4040)) ([#4041](https://github.com/viamin/paid/issues/4041)) ([4c49698](https://github.com/viamin/paid/commit/4c49698e5cd5ff2bf5ae7d0a91e489d6029b703f))
* **inbox:** render clarifying chat in detail frame ([#4038](https://github.com/viamin/paid/issues/4038)) ([13d496f](https://github.com/viamin/paid/commit/13d496f6d41a02d5659a4645533997a8b6c97619))
...
* **models:** reconcile subscription availability instead of reapplying stale catalog exclusions ([#3963](https://github.com/viamin/paid/issues/3963)) ([538a0d9](https://github.com/viamin/paid/commit/538a0d9cfa8174384d63956407c20dcf918cc677))
* no repair path for needs-input label/paid_state drift — issues get stuck invisible to inbox ([#3998](https://github.com/viamin/paid/issues/3998)) ([e1bd5ef](https://github.com/viamin/paid/commit/e1bd5effe6375558b8fe8d687828cf793a912b08))
* prevent duplicate implementation PRs when source-issue linkage is missing ([#4044](https://github.com/viamin/paid/issues/4044)) ([82a040a](https://github.com/viamin/paid/commit/82a040a3153ac1ded4f205b26207bffe5ab50e61))
* prevent stale recovery from reposting unanswered feature clarification questions ([#3958](https://github.com/viamin/paid/issues/3958)) ([d7a6cb3](https://github.com/viamin/paid/commit/d7a6cb367c8c6f5cf709f4eafa4968e93d661540))
* RDR-068: add Apple verification configuration and approval lifecycle ([#3975](https://github.com/viamin/paid/issues/3975)) ([80db430](https://github.com/viamin/paid/commit/80db4301b898414d7707c6a462c921c15c5f7583))
* RDR-068: build immutable macOS image and deterministic guest executor ([#3950](https://github.com/viamin/paid/issues/3950)) ([371b47e](https://github.com/viamin/paid/commit/371b47eab2dc5f0f9c7f0962b0ae6fa9984f1947))
* RDR-068: enforce Paid-controlled network policy for macOS guests ([#3951](https://github.com/viamin/paid/issues/3951)) ([36fc10a](https://github.com/viamin/paid/commit/36fc10aba034e9cf5cb4c1b75dceef11274cbfa1))
* RDR-068: implement trusted macOS host service and Tart provider ([#3948](https://github.com/viamin/paid/issues/3948)) ([7aea621](https://github.com/viamin/paid/commit/7aea6219e0f99bad9ba153a498fd39978e7e5310))
* RDR-068: transfer Apple verification source, results, and artifacts safely ([#3971](https://github.com/viamin/paid/issues/3971)) ([72e7402](https://github.com/viamin/paid/commit/72e7402dc59895e5da4a4295c2c7b8bbaa63316b))
* RDR-068: validate and close out Apple platform verification workers ([#3977](https://github.com/viamin/paid/issues/3977)) ([456eccb](https://github.com/viamin/paid/commit/456eccb242ac7bc30d33e2f4a6ad7f962d3df0e9))
* Read sensitive session data from request body only ([#4034](https://github.com/viamin/paid/issues/4034)) ([b0657ed](https://github.com/viamin/paid/commit/b0657ed99960b5ad0dd9d251788eeffbc8a98442)), closes [#200001838](https://github.com/viamin/paid/issues/200001838)
...
* **runners:** classify preflight session limits, credit exhaustion, and model rejection ([#3961](https://github.com/viamin/paid/issues/3961)) ([04017bd](https://github.com/viamin/paid/commit/04017bd90efe0fbe985dc504f76fafa115e7ebd9))
* **runners:** durably recover subscription-compatible Codex models ([#3994](https://github.com/viamin/paid/issues/3994)) ([5063c66](https://github.com/viamin/paid/commit/5063c66660dcbe68908bc61a776c29c406db674f))
* **runners:** preserve resolved Codex subscription model through build_command ([#3972](https://github.com/viamin/paid/issues/3972)) ([f3b3f3e](https://github.com/viamin/paid/commit/f3b3f3ee0dae1b62cfcaeb779873123c280b44a3))
* **runners:** restore tiered GPT-5.6 Codex subscription execution ([#3946](https://github.com/viamin/paid/issues/3946)) ([9201632](https://github.com/viamin/paid/commit/9201632043d1ee6dcd8045c60c4ac02805577261))
* **runners:** scope fallback to independently enabled agent and chat usage ([#3984](https://github.com/viamin/paid/issues/3984)) ([fcaf688](https://github.com/viamin/paid/commit/fcaf688568a046f346b99c6bf8950ceb8d1168c1))
* **security:** modernize codeql suppression for manifest callback code ([#4043](https://github.com/viamin/paid/issues/4043)) ([84ed794](https://github.com/viamin/paid/commit/84ed7940d503778dca14a13c8e6d58811aadb5cd))
* **stale-runs:** preserve feature clarification pauses ([#3996](https://github.com/viamin/paid/issues/3996)) ([fa5ab8b](https://github.com/viamin/paid/commit/fa5ab8b8d5acbc34efbf6aa4bce2dd40f1e03610))
* Trust verification required for re-opening and editing issues ([#4007](https://github.com/viamin/paid/issues/4007)) ([2d474db](https://github.com/viamin/paid/commit/2d474db721376cd3e408dea5d097b47456a2669d))
