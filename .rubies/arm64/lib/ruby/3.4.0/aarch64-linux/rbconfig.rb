...
module RbConfig
  RUBY_VERSION.start_with?("3.4.") or
    raise "ruby lib version (3.4.2) doesn't match executable version (#{RUBY_VERSION})"

  # Ruby installed directory.
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.4.0/aarch64-linux")
  ...
  CONFIG["MINOR"] = "4"
  CONFIG["TEENY"] = "2"
  CONFIG["PATCHLEVEL"] = "28"
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/hostedtoolcache/Ruby/3.4.2/arm64")
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/hostedtoolcache/Ruby/3.4.2/arm64' '--with-ext=openssl,psych,+' '--enable-shared' '--disable-install-doc' 'CPPFLAGS=-DENABLE_PATH_CHECK=0'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/opt/hostedtoolcache/Ruby/3.4.2/arm64"
  ...
  CONFIG["CXXFLAGS"] = ""
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-DENABLE_PATH_CHECK=0 $(DEFS) $(cppflags)"
  ...
  CONFIG["wasmoptflags"] = ""
  CONFIG["WASMOPT"] = ""
  CONFIG["config_target"] = "aarch64-unknown-linux-gnu"
