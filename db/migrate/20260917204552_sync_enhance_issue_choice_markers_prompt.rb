...
class SyncEnhanceIssueChoiceMarkersPrompt < ActiveRecord::Migration[8.1]
  CHANGE_NOTES = "Require strict choice-question option markers for enumerable clarifying questions"
