...
class CreateExecutionAuditEvents < ActiveRecord::Migration[8.1]
  def up
    unless table_exists?(:execution_audit_events)
    ...
    add_index :execution_audit_events, [ :account_id, :created_at ],
      name: "idx_execution_audit_events_account_created" unless index_exists?(:execution_audit_events, [ :account_id, :created_at ], name: "idx_execution_audit_events_account_created")
    add_index :execution_audit_events, :event_name,
      name: "idx_execution_audit_events_event_name" unless index_exists?(:execution_audit_events, :event_name, name: "idx_execution_audit_events_event_name")
    add_index :execution_audit_events, :runner_key,
      name: "idx_execution_audit_events_runner_key" unless index_exists?(:execution_audit_events, :runner_key, name: "idx_execution_audit_events_runner_key")
    add_index :execution_audit_events, :image_reference,
      name: "idx_execution_audit_events_image_reference" unless index_exists?(:execution_audit_events, :image_reference, name: "idx_execution_audit_events_image_reference")
    add_index :execution_audit_events, [ :resource_type, :resource_id ],
      name: "idx_execution_audit_events_resource" unless index_exists?(:execution_audit_events, [ :resource_type, :resource_id ], name: "idx_execution_audit_events_resource")
    add_index :execution_audit_events, :correlation_id,
      name: "idx_execution_audit_events_correlation_id" unless index_exists?(:execution_audit_events, :correlation_id, name: "idx_execution_audit_events_correlation_id")
    add_index :execution_audit_events, :created_at,
      using: :brin, name: "idx_execution_audit_events_created_at_brin" unless index_exists?(:execution_audit_events, :created_at, name: "idx_execution_audit_events_created_at_brin")
        ...
        BEGIN
          IF NOT EXISTS (
            ...
            WHERE schemaname = current_schema()
              AND tablename = 'execution_audit_events'
  ...
  def down
    return unless table_exists?(:execution_audit_events)
