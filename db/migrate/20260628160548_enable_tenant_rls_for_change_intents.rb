...
class EnableTenantRlsForChangeIntents < ActiveRecord::Migration[8.1]
  def up
    safety_assured do
      execute "ALTER TABLE change_intents ENABLE ROW LEVEL SECURITY"
      execute "ALTER TABLE change_intents FORCE ROW LEVEL SECURITY"
      execute <<~SQL
