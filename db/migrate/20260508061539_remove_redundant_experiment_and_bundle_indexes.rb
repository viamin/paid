...
class RemoveRedundantExperimentAndBundleIndexes < ActiveRecord::Migration[8.1]
  def up
    drop_index "index_bundle_outcomes_on_configuration_bundle_id"
  ...
  def down
    add_index :bundle_outcomes, :configuration_bundle_id,
      name: :index_bundle_outcomes_on_configuration_bundle_id,
      if_not_exists: true
