...
ActiveRecord::Schema[8.1].define(version: 2026_04_28_025840) do
  ...
  create_table "configuration_experiment_assignments", force: :cascade do |t|
    t.bigint "agent_run_id", null: false
  ...
  create_table "configuration_experiment_variants", force: :cascade do |t|
    t.decimal "avg_quality_score", precision: 5, scale: 4
  ...
  create_table "configuration_experiments", force: :cascade do |t|
    t.bigint "account_id"
    t.string "analysis_samples_key"
    t.jsonb "cached_analysis"
    t.datetime "completed_at"
  ...
  create_table "knowledge_recommendations", force: :cascade do |t|
  ...
  create_table "knowledge_usage_stats", force: :cascade do |t|
    t.bigint "agent_run_id", null: false
    t.integer "artifact_count", default: 0, null: false
    t.string "artifact_type", limit: 100, null: false
    t.integer "chunk_count", default: 0, null: false
    t.string "context_type", limit: 50, null: false
    t.datetime "created_at", null: false
  ...
  create_table "llm_output_metrics", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.decimal "composite_score", precision: 5, scale: 4
    t.datetime "created_at", null: false
    t.jsonb "metadata", default: {}, null: false
    t.string "output_type", limit: 30, null: false
    t.bigint "project_id", null: false
    t.string "prompt_slug", limit: 100, null: false
    t.bigint "prompt_version_id"
  ...
  create_table "model_selections", force: :cascade do |t|
    ...
    t.check_constraint "escalated_from_tier IS NULL OR (escalated_from_tier::text = ANY (ARRAY['low'::character varying, 'mid'::character varying, 'high'::character varying]::text[]))", name: "model_selections_escalated_from_tier_check"
  ...
  create_table "user_settings", force: :cascade do |t|
    ...
    t.jsonb "allowed_service_images", default: ["postgres:16.13", "redis:7-alpine", "selenium/standalone-chromium:latest"], null: false
