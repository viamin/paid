...
ActiveRecord::Schema[8.1].define(version: 2026_04_23_132408) do
  ...
  create_table "configuration_experiment_assignments", force: :cascade do |t|
    ...
    t.index ["configuration_experiment_id"], name: "index_config_exp_assignments_on_experiment_id"
    t.index ["configuration_experiment_variant_id"], name: "index_config_exp_assignments_on_variant_id"
  end
  ...
  create_table "configuration_experiment_variants", force: :cascade do |t|
    ...
    t.index ["configuration_experiment_id"], name: "index_config_exp_variants_on_experiment_id"
