...
module ProviderSupport
  ...
  # runs. Currently Claude CLI, Codex CLI, Gemini CLI, Kilocode CLI, OpenCode CLI,
  # and GitHub Copilot CLI are installed in the container image.
  # Update this list when new CLIs are added to the Dockerfile.
  CONTAINER_EXECUTABLE_PROVIDER_KEYS = Set.new(%w[claude codex gemini kilocode opencode copilot]).freeze
